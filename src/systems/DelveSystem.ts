...
import { buildDelveProps, paintDelveFloors } from './delveInterior';
...
export class DelveSystem implements GameSystem {
  ...
  private buildDelveInterior(): void {
    ...
    paintDelveFloors(this.ctx.scene, S, this.delveObjects, this.delveFloorKeys);
    ...
    buildDelveProps(this.ctx.scene, S, this.delveObjects);
  }
