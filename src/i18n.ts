...
const en = {
  ...
  fountain: {
    ...
    festival: '🎉 A festival is under way! Everyone is swift.',
  ...
  inv: {
    ...
    place: 'Place',
    eat: 'Eat',
    loadoutBarTitle: 'Your Loadout — drag any Tool or weapon here; press 1–5 to pick the one in your hand',
    slotHold: (name: string, i: number) => `${name} — press ${i} to hold it`,
    slotEmpty: (i: number) => `Loadout slot ${i} — drag any Tool or weapon here, press ${i} to select`,
  ...
  toast: {
    ...
    festivalStarted: '🎉 The wishes are answered — a festival begins! Everyone is swift.',
...
const de: Strings = {
  ...
  fountain: {
    ...
    festival: '🎉 Ein Dorffest läuft! Alle sind schneller.',
    have: (n) => `du hast ${n}`,
    amount: 'Werfen',
    toss: 'Hineinwerfen',
    cancel: 'Schließen',
  ...
  inv: {
    ...
    place: 'Platzieren',
    eat: 'Essen',
    loadoutBarTitle: 'Deine Ausrüstung — zieh Werkzeuge oder Waffen hierher; drücke 1–5, um eines in die Hand zu nehmen',
    slotHold: (name, i) => `${name} — drücke ${i}, um es in die Hand zu nehmen`,
    slotEmpty: (i) => `Ausrüstungsplatz ${i} — zieh ein Werkzeug oder eine Waffe hierher, drücke ${i} zum Auswählen`,
  ...
  toast: {
    ...
    festivalStarted: '🎉 Die Wünsche sind erhört — ein Dorffest beginnt! Alle sind schneller.',
