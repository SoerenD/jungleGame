/**
 * The Seal monument — "Die Opferschale" (owner-picked from a six-design
 * village-style review, 2026-07-17). A low, wide round field-stone basin on a
 * stepped masonry base (the Village fountain's family). The four offering
 * goods rest on the rim — a timber billet, a grey stone chip, a green fiber
 * coil and a red fruit — with a tiny warm shimmer rising from the center.
 ...
 *
 * Drawn from primitives (tools/png.ts Img); the written PNG doubles as the
 * offline preview. The three Warden-altar monuments reuse this texture.
 *
 * Run: npx tsx tools/compose-seal-monument.ts
 */
